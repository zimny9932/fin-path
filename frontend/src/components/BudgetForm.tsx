...
const BudgetForm = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Plan budżetu na {month}/{year}</CardTitle>
        <CardDescription>
          Zaplanuj swoje przychody i zdefiniuj limity wydatków na ten miesiąc.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="space-y-2">
            <label htmlFor="plannedIncome" className="font-medium">Planowane przychody</label>
            <CurrencyInput
                value={budget.plannedIncome}
